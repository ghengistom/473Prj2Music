...
var client_id = '1752e5e9e3324cce8bdd335f6ea7cd9c'; // client id
var client_secret = '782d25160bfb41909f301da876703ae6'; // client secret
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        // or can pass the token to the browser to make requests from there
        res.redirect('/#' +
          querystring.stringify({
